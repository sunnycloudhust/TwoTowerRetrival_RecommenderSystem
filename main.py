...
def main():
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"\n{'#' * 72}")
        print(f"START EXPERIMENT | K={k} | runs={BASE_HYPERPARAMS['num_runs']}")
        print(f"{'#' * 72}")
        ...
        for run_id, seed in enumerate(seeds, start=1):
            ...
            model = build_model(prep, BASE_HYPERPARAMS, device)
            ...
            scheduler = optim.lr_scheduler.CosineAnnealingLR(
                optimizer,
                T_max=BASE_HYPERPARAMS["epochs"],
                eta_min=BASE_HYPERPARAMS["lr"] * 0.05,
            )
            ...
            best_model_path, history = train(
                ...
                gradient_clip_norm=BASE_HYPERPARAMS["grad_clip"],
                return_history=True,
            )
            ...
            write_final_results_csv(final_rows, experiment["final_results_csv_path"], k)
